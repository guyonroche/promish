...
Promish.nfapply = function(f, args) {
...
Promish.nfcall = function() {
  var f = Array.prototype.shift.apply(arguments);
  return Promish.nfapply(f, arguments);
}
Promish.npost = function(o, f, a) {
  return Promish.nfapply(f.bind(o), a);
}
Promish.ninvoke = function() {
  var o = Array.prototype.shift.apply(arguments);
  var f = Array.prototype.shift.apply(arguments);
  return Promish.nfapply(f.bind(o), arguments);
}
// create curry function for nfcall
Promish.denodify = Promish.promisify = function(f) {
  return function() {
    return Promish.nfapply(f, arguments);
  }
}
...
Promish.nbind = function(f, o) {
  ...
  return function() {
    return Promish.npost(o, f, arguments);
  }
}
// curry function for ninvoke with arguments in 'different' order
Promish.pbind = function(o, f) {
  // if nbind is 'n-type', pbind is 'p-type'
  return function() {
    return Promish.npost(o, f, arguments);
  }
}
...
Promish.promisifyAll = function(o) {
  var p = {};
  var oo = o;
  while (oo && (oo !== Object)) {
    for (var i in oo) {
      var value = oo[i];
      if (!p[i] && (value instanceof Function)) {
        p[i] = Promish.pbind(o, value);
      }
    }
