  ...
  describe(name, function () {
    describe('some', function () {
      it('4, resolve YYYY', function () {
        return new Promise(function (resolve, reject) {
          CPromise.some([
            ...
            CPromise.call(helpersh.curry.timeout(30, null, 3)),
            CPromise.call(helpersh.curry.timeout(40, null, 4))
          ], 4)
      ...
      it('4, resolve YYYN', function () {
        return new Promise(function (resolve, reject) {
          CPromise.some([
            ...
            CPromise.call(helpersh.curry.timeout(20, null, 2)),
            CPromise.call(helpersh.curry.timeout(30, null, 3)),
            CPromise.call(helpersh.curry.timeout(40, new Error('fum')))
          ], 4)
      ...
      it('4, resolve NYYY', function () {
        return new Promise(function (resolve, reject) {
          CPromise.some([
            CPromise.call(helpersh.curry.timeout(10, new Error('fe'))),
            CPromise.call(helpersh.curry.timeout(20, null, 2)),
            CPromise.call(helpersh.curry.timeout(30, null, 3)),
            CPromise.call(helpersh.curry.timeout(40, null, 4))
          ], 4)
